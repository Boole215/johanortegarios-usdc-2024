...
const testSanitize1result = stripSymbolsFromText("the falsity of our own thesis (for the contrary assertion");
const testSanitize1expected = "the falsity of our own thesis for the contrary assertion";
